...
val rubikFamily = FontFamily(
    ...
    Font(R.font.rubik_semibold_italic, weight = FontWeight.SemiBold, style = FontStyle.Italic)
)

val reemKufiFamily = FontFamily(
    Font(R.font.reem_kufi_regular, weight = FontWeight.Normal),
    Font(R.font.reem_kufi_medium, weight = FontWeight.Medium),
