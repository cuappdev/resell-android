        ...
        Row(modifier = Modifier.padding(top = 16.dp, bottom = 32.dp)) {
            ...
            Column(modifier = Modifier.padding(start = 16.dp)){
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(text = "Item Name", style = title1)
                    Image(painter = painterResource(R.drawable.ic_small_dot), contentDescription = null, modifier = Modifier.padding(horizontal = 8.dp))
                    Text(text = "$00.00", style = body1)
                }
                Text("Sold by Seller Name", style = body2, modifier = Modifier.padding(top = 8.dp, bottom = 4.dp))
                Text("Purchased on Month 00, 0000", style = body2)
